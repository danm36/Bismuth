    ...
    public class MIMETypeManager : BismuthGenericManager
    {
        ...
        public override bool Setup()
        {
            MIMETypes = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase) {
                #region MIME List
                // Initial list from https://github.com/samuelneff/MimeTypeMap/blob/master/src/MimeTypes/MimeTypeMap.cs
                {".323", "text/h323"},
                {".3g2", "video/3gpp2"},
                {".3gp", "video/3gpp"},
                {".3gp2", "video/3gpp2"},
            ...
            var cache = MIMETypes.ToList();

            foreach (KeyValuePair<string, string> kvp in cache)
            {
                if (!MIMETypes.ContainsKey(kvp.Value))
                {
        ...
        public static string GetMIMEFromExtension(string extension)
        {
            ...
            if (MIMETypes.ContainsValue(extension))
